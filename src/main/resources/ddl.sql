...
CREATE TABLE IF NOT EXISTS product_item(
    ...
    CONSTRAINT fk_productLine
        FOREIGN KEY (product_line) REFERENCES product(product_id)
             ON DELETE CASCADE
             ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS review (
    ...
    CONSTRAINT fk_product FOREIGN KEY (product) REFERENCES product(product_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS wishlist (
    ...
    CONSTRAINT fk_wishlist_item
        FOREIGN KEY (item) REFERENCES product_item(product_id)
);
